...
| subscription_expired | flags.3?true | Set this flag if the link is a Telegram Star subscription link » and only members with already expired subscription must be returned. |
| peer | InputPeer | Chat |
